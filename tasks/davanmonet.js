...
module.exports = function(grunt) {
	...
	grunt.registerTask('davanmonet', 'A pattern library thingie',  function ()
	{
		...
		grunt.registerTask("davanmonet-startserversdev", ["davanmonet-startservers:dev"])
		grunt.registerTask("davanmonet-startserversbuild", ["davanmonet-startservers:build"])

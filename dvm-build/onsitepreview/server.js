...
if(projectConfig != null)
{
    ...
    if(port != null)
    {
        ...
        app.get('/component-markup/:guid/:state', function (req, res) {
            ...
            const contentIndex = requireUncached('.' + mainConfig.directories.indexing + '/' + mainConfig.indexing.contentindexoutput);
...
{
    console.log('Unable to load configuration, on-site preview server not started')
}